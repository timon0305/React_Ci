...
class App extends React.Component{
  ...
  onFormSubmit(data) {
    ...
    if (this.state.isEditProduct)  {
        apiUrl = 'http://localhost/ci/index.php/reactapi/editProduct';
    } else {
        apiUrl = 'http://localhost/ci/index.php/reactapi/createProduct';
    }

    const myHeaders = new Headers();
    myHeaders.append('Content-Type', 'application/json');
    myHeaders.append('Access-Control-Allow-Methods', 'DELETE');
  ...
  editProduct = productId => {
    const apiUrl = 'http://localhost/ci/index.php/reactapi/getProduct';
